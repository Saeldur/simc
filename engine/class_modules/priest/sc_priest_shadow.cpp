...
void priest_t::generate_apl_shadow()
{
  ...
  cds->add_action( this, covenant.mindgames, "Mindgames",
                   "target_if=insanity<90&(variable.all_dots_up|buff.voidform.up)&!variable.searing_nightmare_cutoff" );
  ...
  main->add_action( this, "Shadow Word: Death",
                    ...
                    "Mindbender or Shadowfiend active. Without Shadowflame this is target capped." );
